namespace NexusForever.Shared.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        Client084A                      = 0x084A, // client add Additive
        Client084E                      = 0x084E, // client applyTradeskillBonus
        Client084F                      = 0x084F, // client complete craft
        Client0850                      = 0x0850, // client complete craft
        Client0851                      = 0x0851, // Start Coordiante Crafting Session
        Client0852                      = 0x0852, // Start Circuitboard Crafting Session
        Server0854                      = 0x0854, // crafting schematic
        Server0856                      = 0x0856, // tradeskills
        Client0857                      = 0x0857, // Learn Tradeskill
        Client0858                      = 0x0858, // Client Reset Tradeskill Talents
        Server0860                      = 0x0860, // Server Tradeskill Learnt
        Server0861                      = 0x0861, // Server Tradeskill Cooldown Updated
